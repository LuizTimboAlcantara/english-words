export const word = [
  {
    ...
    phonetics: [
      {
        text: "/ɪn/",
        audio: "https://api.dictionaryapi.dev/media/pronunciations/en/in-au-stressed.mp3",
        sourceUrl: "https://commons.wikimedia.org/w/index.php?curid=75899732",
        license: {
          name: "BY-SA 4.0",
      ...
      {
        text: "/ɪn/",
        audio: "https://api.dictionaryapi.dev/media/pronunciations/en/in-us-stressed.mp3",
        sourceUrl: "https://commons.wikimedia.org/w/index.php?curid=589445",
        license: {
          name: "BY-SA 3.0",
    ...
    sourceUrls: ["https://en.wiktionary.org/wiki/in"],
  },
  {
    word: "in",
    phonetic: "/ɪn/",
    ...
    meanings: [
      {
        ...
        definitions: [
          {
            definition: "Abbreviation of inch; inches.",
            synonyms: [],
            antonyms: [],
          },
        ],
